...
router.get("/", authMiddleware_1.default, commentController_1.default.getAll.bind(commentController_1.default));
router.get("/:id", commentController_1.default.getById.bind(commentController_1.default));
router.post("/", authMiddleware_1.default, commentController_1.default.create.bind(commentController_1.default));
